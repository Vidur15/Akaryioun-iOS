...
class MemberRequestsVC: UIViewController {
...
extension MemberRequestsVC: UITableViewDelegate,UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.memberDetailsModel?.data?.member?.requests?.count ?? 0
    }
